...
resume_id=abe8f1e0a080952d6bfe4c3325c9679f92c77d06
sep_ie_layers=false
...
run_name=conceptlm__ds_${dataset}__enc_sapbert__k${k}__sd${seed}__iedim${ie_dim}__unfrz${unfreeze_epoch}__${dt}
